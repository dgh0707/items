...
# ossdir = 'mall/2019/1688/img/'
ossdir = 'mall/2019/1688/image/'
...
def uploadFile(file):
    ...
    # cursor.execute("update qw_goods set goodsthumb_status=1 where goods_number=" + date_file + " limit 1")

    # 详情图片的状态
    cursor.execute("update qw_goods set details_status=1 where goods_number=" + date_file + " limit 1")
...
basedir = r'D:\amber\ITEMS\1688\up'
